...
folder_path = r"E:\OneDrive - Masco Group\Desktop\VTS\Nexdecade data\Engine Run Time(DEC)"  # Folder path
...
if all_data:
    ...
    print(final_data)
    output_file = "combined_data.xlsx"  # Change this to your desired output file name
